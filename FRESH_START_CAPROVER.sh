...
# ПОЛНАЯ ПЕРЕУСТАНОВКА С НУЛЯ НА CAPROVER
# Скопируйте и выполните ВСЕ команды ниже в SSH на CapRover

echo "=========================================="
echo "ЭТАП 1: Остановить и удалить старые контейнеры"
echo "=========================================="

sudo docker service rm srv-captain--mikkeller-rc || echo "Service already removed"
sleep 5

echo ""
echo "=========================================="
echo "ЭТАП 2: Очистить базу данных полностью"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "ЭТАП 3: Создать все таблицы ЗАНОВО"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "ЭТАП 4: Развернуть приложение заново"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "ЭТАП 5: Проверить логи"
echo "=========================================="

sudo docker service logs srv-captain--mikkeller-rc 2>&1 | tail -20

echo ""
echo "✅ ГОТОВО! Откройте браузер и проверьте ваш домен CapRover"
